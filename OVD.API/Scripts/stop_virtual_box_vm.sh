...
# Description: This script is for the purpose of STOPPING AN EXISTING virtualbox virtual machine
...
# Usage: Required is the virtual machine name to stop
