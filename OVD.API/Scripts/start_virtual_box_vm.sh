...
# Description: This script is for the purpose of STARTING AN EXISTING virtualbox virtual machine
...
# Usage: Required is the virtual machine name to start
...
VBoxManage startvm "$inputname" --type headless
